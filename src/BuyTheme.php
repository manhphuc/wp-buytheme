...
namespace Yivic\WpPlugin\BuyTheme;


use Yivic\WpPlugin\BuyTheme\Base\Admin;
use Yivic\WpPlugin\BuyTheme\Base\Main;

class BuyTheme {
	const OPTION_KEY = 'buytheme';
	const OPTION_GROUP_NAME = 'buytheme_options';
	...
	public static function plugin_action_links( $links ) {
		...
		$settings_link = '<a href="' . $file_name . '?page=buytheme">' . __( 'Settings', static::text_domain() ) . '</a>';
	...
	public static function default_options() {
		return [
			'title_text'           => __( 'WP Buy Theme', static::text_domain() ),
			'title_class'          => null,
			'title_id'             => null,
		];
	}
